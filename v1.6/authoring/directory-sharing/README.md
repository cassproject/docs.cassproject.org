...
The system allows only manage users on an item If an owner (listed as *Admin*) for the item.
...
* In the ***Details*** section of the ***Information panel***, click on ***copy link***
    * This copies the shareable link to the clipboard
...
A dialogue window shows options for adding Users or Groups to the item. The system allows:
...
For directories and frameworks, a shareable link shows at the top of the window and provides a button to copy the link to the clipboard. This option offers a method for sharing directories, given that exporting directories is not available at this time.
