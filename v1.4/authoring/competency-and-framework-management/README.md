...
![CAT Competency Framework Management - Frameworks Page](/1.4/authoring/frameworks-page.png)
...
![CAT Competency Framework Management - Filter Button](/1.4/authoring/filter-frameworks-button.png)
...
![CAT Competency and Framework Management - Filter and Sort Panel](/1.4/authoring/filter-and-sort-panel.png)
...
![CAT Competency and Framework Management - Search Apply Term TO](/1.4/authoring/search-apply-to.png)
...
![CAT Competency and Framework Management - Search Apply Term TO](/1.4/authoring/search-field-types.png)
...
![CAT Competency and Framework Management - Information Panel](/1.4/authoring/framework-information.png)
...
![CAT Competency Framework Management - Create New Framework](/1.4/authoring/create-new-framework.png)
...
![CAT Competency Framework Management - Add Competencies](/1.4/authoring/add-competencies.png)
...
![CAT Competency Framework Management - Add Children to Competencies](/1.4/authoring/add-children-competencies.png)
...
![CAT Competency Framework Management - Edit](/1.4/authoring/edit-competencies.png)
...
![CAT Competency Framework Management - Edit Modal](/1.4/authoring/edit-modal.png)
...
![CAT Competency Framework Management - Add a Property](/1.4/authoring/add-property.png)
...
![CAT Competency Framework Management - Edit Multiple Competencies](/1.4/authoring/edit-multiple-competencies.png)
...
![CAT Competency Framework Management - Adding Property to Multiple Competencies](/1.4/authoring/adding-property-to-multiple.png)
...
![CAT Competency Framework Management - Undo Button](/1.4/authoring/undo-button.png)
...
![CAT Competency Framework Management - Drag and Drop](/1.4/authoring/drag-and-drop.png)
...
![CAT Competency Framework Management - Cut, Copy, Paste](/1.4/authoring/cut-copy-paste.png)
...
![CAT Competency Framework Management - Setting a Framework Configuration](/1.4/authoring/setting-a-framework-configuration.png)
...
![CAT Competency Framework Management - Manage Framework Configuration](/1.4/authoring/manage-framework-configuration.png)
...
![CAT Competency Framework Management - Manage Users Button](/1.4/authoring/manage-users-button.png)
...
![CAT Competency Framework Management - Share Framework and Manage Users](/1.4/authoring/share-framework-and-manage-users.png)
...
![CAT Competency Framework Management - Property Details](/1.4/authoring/property-details.png)
