...
![Competency Configuration](/1.4/authoring/competency-configuration.png)
...
![Add Custom Competency Property](/1.4/authoring/add-custom-property.png)

Once clicked, the ***New Competency Property*** dialogue window is displayed.

![New Competency Property](/1.4/authoring/new-competency-property.png)
...
![One Entry Per Language](/1.4/authoring/one-entry-per-language.png)
...
![Limit Values](/1.4/authoring/limit-values-competency.png)
...
![Limit Values Enabled](/1.4/authoring/limit-values-enabled-competency.png)
...
Custom properties can be edited and deleted by selecting the appropriate action buttons to the right of the corresponding property entry in the ***Competency Properties*** list.
 ...
 ![Delete Custom Properties](/1.4/authoring/competency-properties.png)
...
![Restrict Competency Types](/1.4/authoring/restrict-competency-types.png)
...
![Permitted Values Table](/1.4/authoring/permitted-values.png)
...
![Allow Levels](/1.4/authoring/allow-levels.png)
...
![Restrict Competency Levels](/1.4/authoring/restrict-levels.png)
...
![Enforced Levels](/1.4/authoring/enforced-levels.png)
...
![Add Levels](/1.4/authoring/add-level.png)
...
![Add New Level Modal](/1.4/authoring/add-new-level.png)
...
Upon selecting the desired enforced levels, click the ***apply selected*** button at the bottom right of the ***select enforced levels*** dialog window to apply the enforced levels to competencies.
 ...
 ![Select Enforced Levels](/1.4/authoring/apply-selected.png)
...
![Competnecy Relationship Configuration](/1.4/authoring/competency-relationships-configuration.png)
...
![Relationship Display Options](/1.4/authoring/display-options.png)
...
![Relationship Types Management](/1.4/authoring/relationship-types.png)
...
![Relationship Types Enabled Toggle](/1.4/authoring/relationship-types-enabled.png)
...
![Manage Relationships](/1.4/authoring/manage-relationships.png)
...
![Manage Relationship Types](/1.4/authoring/relationship-types.png)
...
![Resource Alignemnt Configuration](/1.4/authoring/resource-alignment-configuration.png)
