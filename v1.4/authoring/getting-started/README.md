...
![Welcome Page](/1.4/authoring/welcome-page.png)
...
![Expand Menu Button](/1.4/authoring/expand-menu-button.png)

![Expanded Menu](/1.4/authoring/expanded-menu.png)
...
![Collapse Menu](/1.4/authoring/collapse-menu-button.png)
...
![Collapsed Menu](/1.4/authoring/collapsed-menu.png)
...
![CAT Navigation Menu - Login Button](/1.4/authoring/login-button.png)
...
![CAT Login - Create Account Button](/1.4/authoring/create-account-button.png)
...
![CAT Login - Create Account Submit Button](/1.4/authoring/create-account-submit-button.png)
...
![CAT Login - Login Button](/1.4/authoring/login-button.png)
...
![CAT Welcome - Helpful Links ](/1.4/authoring/helpful-links.png)
