...
![Configurations Navigation Menu](/1.4/authoring/configurations.png)
...
![Configuration Action Browser Default](/1.4/authoring/browser-default.png)

It is also possible for users to set their browser default configuration from this screen

![Browser Default](/1.4/authoring/view-manage-delete.png)
...
![Create new Configuration](/1.4/authoring/create-new-configuration.png)
...
![General Details](/1.4/authoring/general-details.png)
...
![Save Configuration](/1.4/authoring/save-configuration.png)
