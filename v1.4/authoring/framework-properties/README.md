...
![Framework Configuration](/1.4/authoring/framework-properties.png)
...
![Add Custom Framework Property](/1.4/authoring/add-custom-framework-property.png)

Once clicked, the _New Framework Property_ dialogue window is displayed.

![New Framework Property](/1.4/authoring/new-framework-property.png)
...
![Limit Values](/1.4/authoring/limit-values.png)
...
![Limit Value Entries](/1.4/authoring/limit-values-framework.png)
...
![Delete Custom Properties](/1.4/authoring/framework-configuration.png)
