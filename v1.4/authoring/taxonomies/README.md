...
![CAT Taxonomy Management - Taxonomies Icon](/1.4/authoring/taxonomies-icon.png)
...
![CAT Taxonomy Management - Taxonomy List](/1.4/authoring/taxonomies-list.png)
...
![CAT Taxonomy Management - Filter Button](/1.4/authoring/taxonomies-filter-button.png)

The filter button will open up a side panel to the right of the taxonomy list with options to sort and filter the list.

![CAT Taxonomy Management - Filter and Sort Panel](/1.4/authoring/taxonomies-filter-and-sort.png)
...
![CAT Taxonomy Management - Create New Taxonomy](/1.4/authoring/taxonomies-create-new.png)
...
![CAT Taxonomy Management - Add Concepts](/1.4/authoring/taxonomies-add-concepts.png)
...
![CAT Taxonomy Management - Add Children to Concepts](/1.4/authoring/taxonomies-add-child.png)
...
![CAT Taxonomy Management - Edit](/1.4/authoring/taxonomies-edit.png)
...
![CAT Taxonomy Management - Edit Modal](/1.4/authoring/taxonomies-edit-modal.png)
...
![CAT Taxonomy Management - Add a Property](/1.4/authoring/taxonomies-add-property.png)
...
![CAT Taxonomy Management - Edit Multiple Concepts](/1.4/authoring/taxonomies-edit-multiple.png)
...
![CAT Taxonomy Management - Adding Property to Multiple Concepts](/1.4/authoring/taxonomies-adding-property-to-multiple.png)
...
![CAT Taxonomy Management - Undo Button](/1.4/authoring/taxonomies-undo-button.png)
...
![CAT Taxonomy Management - Drag and Drop](/1.4/authoring/taxonomies-drag-and-drop.png)
...
![CAT Taxonomy Management - Cut, Copy, Paste](/1.4/authoring/taxonomies-cut-copy-paste.png)
...
![CAT Taxonomy Management - Manage Users Button](/1.4/authoring/taxonomies-users-button.png)
...
![CAT Taxonomy Management - Share Taxonomy and Manage Users](/1.4/authoring/taxonomies-manage-users.png)
...
![CAT Taxonomy Management - Property Details](/1.4/authoring/taxonomies-property-details.png)
...
![CAT Taxonomy Management - Export Button](/1.4/authoring/exporting-frameworks.png)
...
![CAT Taxonomy Management - Export Oprtions](/1.4/authoring/select-option-export.png)
...
![CAT Taxonomy Management - Import Button ](/1.4/authoring/taxonomy-import-button.png)
...
![CAT Taxonomy Management - Import Page](/1.4/authoring/taxonomy-import-page.png)
