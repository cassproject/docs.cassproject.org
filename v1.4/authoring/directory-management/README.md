...
![Directory Management - Directory List](/1.4/authoring/directory-list.png)
...
![Directory Management - Directories Icon](/1.4/authoring/directory-icon.png)
...
![Directory Management - Directory Path](/1.4/authoring/directory-breadcrumbs.png)
...
![Directory Management - Directory Path](/1.4/authoring/directory-cass-link.png)
...
![Framework - Go To Directory](/1.4/authoring/framework-go-to-directory.png)
...
![Directory Management - Directory Information](/1.4/authoring/directory-information.png)
...
- **Details** (only available for directories and frameworks)
    ...
    ![Directory Management - Directory Information Details](/1.4/authoring/directory-information-details.png)
- **Users** - Click on "manage users and privacy" and a window dialogue will allow you to view and control access to this item.
    ![Directory Management - Directory Information Users](/1.4/authoring/directory-information-users.png)
...
![Directory Management - Directory Editable](/1.4/authoring/directory-editable.png)
...
![Directory Management - Create New](/1.4/authoring/directory-create-new.png)
...
![Directory Management - Add New](/1.4/authoring/directory-add-new.png)
...
![Directory Management - Create Directory](/1.4/authoring/directory-create.png)
...
![Directory Management - Create Resource](/1.4/authoring/directory-create-resource.png)
...
![Directory Management - Copy Progress Bar](/1.4/authoring/directory-copy-progress.png)
...
![Directory Management - Delete Directory](/1.4/authoring/directory-delete.png)
