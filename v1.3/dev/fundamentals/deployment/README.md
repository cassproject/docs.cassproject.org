...
By default, the CASS Installation installs a web server (*Apache2 or HTTPD*), an application server (*Tomcat*), and a database (*ElasticSearch*). The web server may be moved to another machine and scaled horizontally/vertically without issue.
