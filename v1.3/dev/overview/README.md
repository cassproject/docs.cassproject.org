...
* [Servlet Container](https://dzone.com/articles/what-servlet-container) ([Tomcat](http://tomcat.apache.org/) on port 8080)
    * WAR File
        * [Maven](https://maven.apache.org/) Compiler
            * [CaSS Javascript Library](https://github.com/cassproject/CASS/tree/master/src/main/js/cass)
            * CaSS Repository (aka: [SkyRepo](https://github.com/Eduworks/ew/tree/master/ew.levr.db.skyrepo))
            * [LEVR](https://github.com/eduworks/ew/)
...
The [CaSS Javascript Library](https://github.com/cassproject/CASS/tree/master/src/main/js/cass) is the easiest way to work with CaSS. It provides the code necessary to utilize all CaSS objects (not strictly necessary in very simple cases).
