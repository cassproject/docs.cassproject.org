...
![Directory Management - Directory List](/v1.3/authoring/directory-list.png)
...
![Directory Management - Directories Icon](/v1.3/authoring/directory-icon.png)
...
![Directory Management - Directory Path](/v1.3/authoring/directory-breadcrumbs.png)
...
![Directory Management - Directory Path](/v1.3/authoring/directory-cass-link.png)
...
![Framework - Go To Directory](/v1.3/authoring/framework-go-to-directory.png)
...
![Directory Management - Directory Information](/v1.3/authoring/directory-information.png)
...
- **Details** (only available for directories and frameworks)
    ...
    ![Directory Management - Directory Information Details](/v1.3/authoring/directory-information-details.png)
- **Users** - Click on "manage users and privacy" and a window dialogue will allow you to view and control access to this item.
    ![Directory Management - Directory Information Users](/v1.3/authoring/directory-information-users.png)
...
![Directory Management - Directory Editable](/v1.3/authoring/directory-editable.png)
...
![Directory Management - Create New](/v1.3/authoring/directory-create-new.png)
...
![Directory Management - Add New](/v1.3/authoring/directory-add-new.png)
...
![Directory Management - Create Directory](/v1.3/authoring/directory-create.png)
...
![Directory Management - Create Resource](/v1.3/authoring/directory-create-resource.png)
...
![Directory Management - Copy Progress Bar](/v1.3/authoring/directory-copy-progress.png)
...
![Directory Management - Delete Directory](/v1.3/authoring/directory-delete.png)
