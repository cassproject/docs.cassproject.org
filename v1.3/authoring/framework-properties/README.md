...
![Framework Configuration](/v1.3/authoring/framework-properties.png)
...
![Add Custom Framework Property](/v1.3/authoring/add-custom-framework-property.png)

Once clicked, the _New Framework Property_ dialogue window is displayed.

![New Framework Property](/v1.3/authoring/new-framework-property.png)
...
![Limit Values](/v1.3/authoring/limit-values.png)
...
![Limit Value Entries](/v1.3/authoring/limit-values-framework.png)
...
![Delete Custom Properties](/v1.3/authoring/framework-configuration.png)
