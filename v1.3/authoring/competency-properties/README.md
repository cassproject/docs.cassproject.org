...
![Competency Configuration](/v1.3/authoring/competency-configuration.png)
...
![Add Custom Competency Property](/v1.3/authoring/add-custom-property.png)

Once clicked, the ***New Competency Property*** dialogue window is displayed.

![New Competency Property](/v1.3/authoring/new-competency-property.png)
...
![One Entry Per Language](/v1.3/authoring/one-entry-per-language.png)
...
![Limit Values](/v1.3/authoring/limit-values-competency.png)
...
![Limit Values Enabled](/v1.3/authoring/limit-values-enabled-competency.png)
...
Custom properties can be edited and deleted by selecting the appropriate action buttons to the right of the corresponding property entry in the ***Competency Properties*** list.
 ...
 ![Delete Custom Properties](/v1.3/authoring/competency-properties.png)
...
![Restrict Competency Types](/v1.3/authoring/restrict-competency-types.png)
...
![Permitted Values Table](/v1.3/authoring/permitted-values.png)
...
![Allow Levels](/v1.3/authoring/allow-levels.png)
...
![Restrict Competency Levels](/v1.3/authoring/restrict-levels.png)
...
![Enforced Levels](/v1.3/authoring/enforced-levels.png)
...
![Add Levels](/v1.3/authoring/add-level.png)
...
![Add New Level Modal](/v1.3/authoring/add-new-level.png)
...
Upon selecting the desired enforced levels, click the ***apply selected*** button at the bottom right of the ***select enforced levels*** dialog window to apply the enforced levels to competencies.
 ...
 ![Select Enforced Levels](/v1.3/authoring/apply-selected.png)
...
![Competnecy Relationship Configuration](/v1.3/authoring/competency-relationships-configuration.png)
...
![Relationship Display Options](/v1.3/authoring/display-options.png)
...
![Relationship Types Management](/v1.3/authoring/relationship-types.png)
...
![Relationship Types Enabled Toggle](/v1.3/authoring/relationship-types-enabled.png)
...
![Manage Relationships](/v1.3/authoring/manage-relationships.png)
...
![Manage Relationship Types](/v1.3/authoring/relationship-types.png)
...
![Resource Alignemnt Configuration](/v1.3/authoring/resource-alignment-configuration.png)
