...
![CAT Competency Framework Management - Crosswalk Frameworks Navigation](/v1.3/authoring/crosswalk-navigation.png)
...
![CAT Crosswalk Frameworks - Progress Bar](/v1.3/authoring/progress-bar.png)
...
![CAT Crosswalk Frameworks - Main Alignment Screen](/v1.3/authoring/main-alignment-screen.png)
...
![CAT Crosswalk Frameworks - Crosswalk Action Buttons](/v1.3/authoring/action-buttons.png)
...
![CAT Crosswalk Frameworks - Relationship Add Button](/v1.3/authoring/relationship-add-button.png)

Select the desired relationship type from the dropdown.

![CAT Crosswalk Frameworks - Relationship Type Selection](/v1.3/authoring/relationship-type-selection.png)
...
![CAT Crosswalk Frameworks - Target Competency Selection](/v1.3/authoring/target-competency-selection.png)
...
![CAT Crosswalk Frameworks - Apply Alignments Button.](/v1.3/authoring/apply-alignments-button.png)

![CAT Crosswalk Frameworks - Alignment Change Tally](/v1.3/authoring/alignment-change-tally.png)
...
![CAT Crosswalk Frameworks - Alignment Bubble](/v1.3/authoring/alignment-bubble.png)
...
![CAT Crosswalk Frameworks - Target Competency Removal](/v1.3/authoring/target-competency-removal.png)
...
![CAT Crosswalk Frameworks - Apply Alignments Button.](/v1.3/authoring/apply-alignment-bubble.png)

![CAT Crosswalk Frameworks - Alignment Change Tally](/v1.3/authoring/alignment-removing-one.png)
...
![CAT Crosswalk Frameworks - Save & Review](/v1.3/authoring/alignment-save-and-review.png)
...
![CAT Crosswalk Frameworks - Crosswalk Alignment Summary](/v1.3/authoring/alignment-summary.png)

![CAT Crosswalk Frameworks - Framework Application Selection](/v1.3/authoring/framework-application-selection.png)

If you wish to make further changes to the alignments, click on the ***continue editing*** button.

![CAT Crosswalk Frameworks - Continue Editing Button](/v1.3/authoring/continue-editing.png)

When you are satisfied with your changes, click on the ***save alignments*** button.

![CAT Crosswalk Frameworks - Save Alignments Button](/v1.3/authoring/save-alignments.png)
