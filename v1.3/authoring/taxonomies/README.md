...
![CAT Taxonomy Management - Taxonomies Icon](/v1.3/authoring/taxonomies-icon.png)
...
![CAT Taxonomy Management - Taxonomy List](/v1.3/authoring/taxonomies-list.png)
...
![CAT Taxonomy Management - Filter Button](/v1.3/authoring/taxonomies-filter-button.png)

The filter button will open up a side panel to the right of the taxonomy list with options to sort and filter the list.

![CAT Taxonomy Management - Filter and Sort Panel](/v1.3/authoring/taxonomies-filter-and-sort.png)
...
![CAT Taxonomy Management - Create New Taxonomy](/v1.3/authoring/taxonomies-create-new.png)
...
![CAT Taxonomy Management - Add Concepts](/v1.3/authoring/taxonomies-add-concepts.png)
...
![CAT Taxonomy Management - Add Children to Concepts](/v1.3/authoring/taxonomies-add-child.png)
...
![CAT Taxonomy Management - Edit](/v1.3/authoring/taxonomies-edit.png)
...
![CAT Taxonomy Management - Edit Modal](/v1.3/authoring/taxonomies-edit-modal.png)
...
![CAT Taxonomy Management - Add a Property](/v1.3/authoring/taxonomies-add-property.png)
...
![CAT Taxonomy Management - Edit Multiple Concepts](/v1.3/authoring/taxonomies-edit-multiple.png)
...
![CAT Taxonomy Management - Adding Property to Multiple Concepts](/v1.3/authoring/taxonomies-adding-property-to-multiple.png)
...
![CAT Taxonomy Management - Undo Button](/v1.3/authoring/taxonomies-undo-button.png)
...
![CAT Taxonomy Management - Drag and Drop](/v1.3/authoring/taxonomies-drag-and-drop.png)
...
![CAT Taxonomy Management - Cut, Copy, Paste](/v1.3/authoring/taxonomies-cut-copy-paste.png)
...
![CAT Taxonomy Management - Manage Users Button](/v1.3/authoring/taxonomies-users-button.png)
...
![CAT Taxonomy Management - Share Taxonomy and Manage Users](/v1.3/authoring/taxonomies-manage-users.png)
...
![CAT Taxonomy Management - Property Details](/v1.3/authoring/taxonomies-property-details.png)
...
![CAT Taxonomy Management - Export Button](/v1.3/authoring/exporting-frameworks.png)
...
![CAT Taxonomy Management - Export Oprtions](/v1.3/authoring/select-option-export.png)
...
![CAT Taxonomy Management - Import Button ](/v1.3/authoring/taxonomy-import-button.png)
...
![CAT Taxonomy Management - Import Page](/v1.3/authoring/taxonomy-import-page.png)
