...
![Configurations Navigation Menu](/v1.3/authoring/configurations.png)
...
![Configuration Action Browser Default](/v1.3/authoring/browser-default.png)

It is also possible for users to set their browser default configuration from this screen

![Browser Default](/v1.3/authoring/view-manage-delete.png)
...
![Create new Configuration](/v1.3/authoring/create-new-configuration.png)
...
![General Details](/v1.3/authoring/general-details.png)
...
![Save Configuration](/v1.3/authoring/save-configuration.png)
