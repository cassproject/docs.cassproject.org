...
![Welcome Page](/v1.3/authoring/welcome-page.png)
...
![Expand Menu Button](/v1.3/authoring/expand-menu-button.png)

![Expanded Menu](/v1.3/authoring/expanded-menu.png)
...
![Collapse Menu](/v1.3/authoring/collapse-menu-button.png)
...
![Collapsed Menu](/v1.3/authoring/collapsed-menu.png)
...
![CAT Navigation Menu - Login Button](/v1.3/authoring/login-button.png)
...
![CAT Login - Create Account Button](/v1.3/authoring/create-account-button.png)
...
![CAT Login - Create Account Submit Button](/v1.3/authoring/create-account-submit-button.png)
...
![CAT Login - Login Button](/v1.3/authoring/login-button.png)
...
![CAT Welcome - Helpful Links ](/v1.3/authoring/helpful-links.png)
