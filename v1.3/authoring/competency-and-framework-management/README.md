...
![CAT Competency Framework Management - Frameworks Page](/v1.3/authoring/frameworks-page.png)
...
![CAT Competency Framework Management - Filter Button](/v1.3/authoring/filter-frameworks-button.png)
...
![CAT Competency and Framework Management - Filter and Sort Panel](/v1.3/authoring/filter-and-sort-panel.png)
...
![CAT Competency and Framework Management - Search Apply Term TO](/v1.3/authoring/search-apply-to.png)
...
![CAT Competency and Framework Management - Search Apply Term TO](/v1.3/authoring/search-field-types.png)
...
![CAT Competency and Framework Management - Information Panel](/v1.3/authoring/framework-information.png)
...
![CAT Competency Framework Management - Create New Framework](/v1.3/authoring/create-new-framework.png)
...
![CAT Competency Framework Management - Add Competencies](/v1.3/authoring/add-competencies.png)
...
![CAT Competency Framework Management - Add Children to Competencies](/v1.3/authoring/add-children-competencies.png)
...
![CAT Competency Framework Management - Edit](/v1.3/authoring/edit-competencies.png)
...
![CAT Competency Framework Management - Edit Modal](/v1.3/authoring/edit-modal.png)
...
![CAT Competency Framework Management - Add a Property](/v1.3/authoring/add-property.png)
...
![CAT Competency Framework Management - Edit Multiple Competencies](/v1.3/authoring/edit-multiple-competencies.png)
...
![CAT Competency Framework Management - Adding Property to Multiple Competencies](/v1.3/authoring/adding-property-to-multiple.png)
...
![CAT Competency Framework Management - Undo Button](/v1.3/authoring/undo-button.png)
...
![CAT Competency Framework Management - Drag and Drop](/v1.3/authoring/drag-and-drop.png)
...
![CAT Competency Framework Management - Cut, Copy, Paste](/v1.3/authoring/cut-copy-paste.png)
...
![CAT Competency Framework Management - Setting a Framework Configuration](/v1.3/authoring/setting-a-framework-configuration.png)
...
![CAT Competency Framework Management - Manage Framework Configuration](/v1.3/authoring/manage-framework-configuration.png)
...
![CAT Competency Framework Management - Manage Users Button](/v1.3/authoring/manage-users-button.png)
...
![CAT Competency Framework Management - Share Framework and Manage Users](/v1.3/authoring/share-framework-and-manage-users.png)
...
![CAT Competency Framework Management - Property Details](/v1.3/authoring/property-details.png)
